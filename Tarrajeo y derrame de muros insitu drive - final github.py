...
try:
    Dynamo= "https://raw.githubusercontent.com/ScorpionsIngenieros/Tar_alg/main/tar_alg1.png"

    Path=IO.Path.GetTempPath() + "tar_alg1.png"
    ...
    if os.path.exists(Path):
        ...
        for a in [Dynamo]:
            ...
            img.Save(IO.Path.GetTempPath() + "tar_alg1.png", Imaging.ImageFormat.Png)
except:
