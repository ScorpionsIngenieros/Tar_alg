...
bitmapImage = System.Drawing.Bitmap(Path) 
...
class Tarrajeo(Form):
    ...
    def setupPanel2(self):
        ...
        labelcksizoc= Label()
        labelcksizoc.Text= "Contiene zocalo:"
        ...
        self.cksizoc.Name="Contiene zocalo:"  
        ...
        self.cknozoc.CheckStateChanged += self.cknozocmet   
        ...
        self.r1= urllib2.urlopen('https://raw.githubusercontent.com/ScorpionsIngenieros/Tar_alg/main/ipfer.txt')  
    ...
    def butgomet(self,sender,args):   
        if (sender.Click and self.ckmurinsv.Checked and self.r1 == socket.gethostbyname(socket.gethostname())):
            try:
